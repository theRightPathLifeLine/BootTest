package com.line.thirdparty.mastercontrol.xmlbean;
...
public class Param {
    ...
    public Param(int fromStationID, int toStationID) {
		super();
	...
	public String toString() {
		return "Param [fromStationID=" + fromStationID + ", toStationID="
				+ toStationID + ", command=" + command + "]";
	}
